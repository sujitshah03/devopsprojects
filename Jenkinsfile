node{
  ...
  stage('Deploy to Tomcat'){
	...
	slackSend baseUrl:'https://hooks.slack.com/services/', channel: '#webapps', color: '#439FE0', message: "job started" , tokenCredentialId: 'slack-secret', username: 'devops-hvs5481'
	}
}
